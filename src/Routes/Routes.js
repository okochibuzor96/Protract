  ...
  const routerMain = createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        {
          index:true,
          element:<Suspense fallback={<div style={{display:'flex', alignItems:'center', justifyContent:'center',width:'100%', height:'85vh', backgroundColor:"gray"}}>Loading...</div>}><PaymentIndex/></Suspense>
        },
        {
          path:"payment_details/:id",
          element:<Suspense fallback={<div style={{display:'flex', alignItems:'center', justifyContent:'center',width:'100%', height:'85vh', backgroundColor:"gray"}}>Loading...</div>}><PaymentDetails/></Suspense>
        }
      ]
    },
    {
      ...
      children:[
        ...
        },
        {
          ...
          element:<Suspense fallback={<div style={{display:'flex', alignItems:'center', justifyContent:'center',width:'100%', height:'85vh', backgroundColor:"gray"}}>Loading...</div>}><UserDetailsLayout/></Suspense>,
          children:[
            {
                index:true,
    ...
    },
    {
      ...
      children: [
        {
          index: true,
          element: <Suspense fallback={<div style={{display:'flex', alignItems:'center', justifyContent:'center',width:'100%', height:'85vh', backgroundColor:"gray"}}>Loading...</div>}><EvaluationIndex/></Suspense>
        },
        {
          path: "new-evaluation",
          element: <Suspense fallback={<div style={{display:'flex', alignItems:'center', justifyContent:'center',width:'100%', height:'85vh', backgroundColor:"gray"}}>Loading...</div>}><NewEvaluation/></Suspense>
        },
        {
          path:"evaluation-details/:id",
          element:<Suspense fallback={<div style={{display:'flex', alignItems:'center', justifyContent:'center',width:'100%', height:'85vh', backgroundColor:"gray"}}>Loading...</div>}><DetailsLayout/></Suspense>
        }
      ]
    },
    {
