...
function ContractorsLayout() {
  ...
  const getUser = GetUsers.Contractor({page,limit})

  const totalPage = contractors && Math.ceil(contractors.length/limit)
  ...
  const handleNavigation = () => navigate('/contractors/new_contractor')

  return (
    
    <div className={contractor.contractIndexContainer}>
      
      <div className={contractor.block54}> 

        <div className={contractor.block55}>Contractors</div>

        <button  onClick={handleNavigation} className={contractor.block56}>
      ...
      <div className={contractor.contractorTable}>
        ...
        <div >
          ...
          <div className={contractor.contractorTableContainer}>
             ...
             contractors?
              (
                ...
                getUser.map((item,index)=>(
                  ...
                  <React.Fragment key={index}>
                    ...
                    <div className={contractor.block70}> 
                    ...
                    <div className={dashboard.mobile}>
                      ...
                      <div className={dashboard.content}>
                        ...
                        <div>
                          ...
                          <div className={`${dashboard.statusWrapper}`} onClick={()=>navigate(`/contractors/contractor_details/${item.id}`)}>
              ...
              (
                <div className={contractor.noDataWrapper}>
                  ...
                  <div> 
                    click on <span onClick={handleNavigation}> Add contractor</span> or on the  Add Contractor button at the top right to add data
                  </div>
