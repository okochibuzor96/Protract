...
function UserIndex() {
    ...
    const handleNavigation = () => navigate('new-staff')
  ...
  return (
    <div className={userStyle.userLayoutContainer}>
        ...
        <div>
            ...
            <button onClick={handleNavigation}>Add User</button>
        ...
        <div className={userStyle.IndexTable}>
                ...
                <div className={userStyle.tableContainer}>
...

                    {
                        users?(
...

                                    {
                                        getUser.map((item,i) =>(
                                            ...
                                            <React.Fragment key={i}>
                                                ...
                                                <div  className={userStyle.userTbody}>
                                                ...
                                                <div className={dashboard.mobile}>
                                                    ...
                                                    <div className={dashboard.content}>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className={`${dashboard.statusWrapper}`} onClick={()=> navigate(`user-details/${item.id}`)}>
                            ...
                            <div> 
                                click on <span onClick={handleNavigation}>Add User</span> or on the  Add User button at the top right to add data
                            </div>
