...
function Evaluation_Index() {
    ...
    const handleNavigation = ()=> navigate('new-evaluation')
  ...
  return (
    <div className={evaluations.evaluationContainer}>
        ...
        <div>
            ...
            <button  onClick={handleNavigation}>New Evaluation</button>
        ...
        <div className={evaluations.IndexTable}>

            <div>

                <div className={evaluations.tableContainer}>
                                                    ...
                                                    <div className={dashboard.mobile}>
                                                        ...
                                                        <div className={dashboard.content}>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div>
                                                                {item.projectFormValue}
                                                                </div>

                                                                <div className={`${dashboard.statusWrapper}`} onClick={()=> navigate(`evaluation-details/${item.id}`)}>
